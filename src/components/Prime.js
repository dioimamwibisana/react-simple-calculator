...
import {get_n_primes} from '../utils';
...
class Prime extends Component{
	...
	handleSubmit(event) {
		...
		let result_prime = get_n_primes(first_number);
		this.setState({
			result: result_prime.join(",")
		});
		event.preventDefault();
	}
	render() {
		...
		return(
			<Fragment>
				<span className="tagline">Find first N prime number, and print the result</span>
